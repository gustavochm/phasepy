...
Usual equilibrium calculations includes vapor liquid equilibrium (flash, bubble point, dew point), liquid liquid equilibrium (flash and stability test) and vapor liquid liquid equilibrium (multiflash and stability test). Those algorithms are described in the following sections:
