...
Phasepy :class:`phasepy.component` function creates an object that stores necessary pure component information needed for equilibria and interfacial properties computation. The following parameters are allowed.
...
Besides storing pure component data, the created object incorporates basics methods for saturation pressure evaluation and liquid volume with Rackett equation.
