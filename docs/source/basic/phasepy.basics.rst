...
In order to start with phase equilibrium calculations it is necessary to provided pure 
component and mixture info. Phasepy is an object oriented python package that implements 
